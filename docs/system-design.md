...
| 层级 | 技术 | 版本 | 选型理由 |
|------|------|------|----------|
| **前端 (移动)** | UniApp | 3.x | 一套代码编译多端 (微信小程序/H5/App) |
...
C4Context
    ...
    System_Boundary(system, "物业透明化系统") {
        Container(mobile_app, "小程序/移动端", "UniApp", "业主/物业人员操作入口")
    ...
    Rel(platform_admin, api_gateway, "管理")
...
gantt
    ...
    section P1 MVP
    账户/小区模块       :2026-06-15, 14d
    财务台账模块       :2026-06-20, 21d
    凭证管理模块       :2026-06-25, 14d
    基础大屏           :2026-07-01, 10d
    小程序基础功能     :2026-06-25, 21d
...
| 里程碑 | 时间 | 交付物 |
|--------|------|--------|
| M1: 设计完成 | 2026-06-10 | 设计文档 + 原型 |
| M2: MVP 上线 | 2026-07-10 | 1 个小区试点 |
| M3: 增强完成 | 2026-07-31 | 3-5 个小区 |
| M4: 信任深化 | 2026-08-20 | 哈希链 + 校验页 |
| M5: 商业化 | 2026-09-15 | 司法链 + 生态 |
